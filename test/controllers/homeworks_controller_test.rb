...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { assignment: @homework.assignment, course_id: @homework.course_id, days_id: @homework.days_id }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { assignment: @homework.assignment, course_id: @homework.course_id, days_id: @homework.days_id }
    assert_redirected_to homework_path(assigns(:homework))
  end
